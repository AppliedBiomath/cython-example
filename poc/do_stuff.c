...
#define __PYX_HAVE__poc__do_stuff
#define __PYX_HAVE_API__poc__do_stuff
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "do_stuff",
    __pyx_k_Example_Cython_module_that_calls, /* m_doc */
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initdo_stuff(void); /*proto*/
PyMODINIT_FUNC initdo_stuff(void)
#else
PyMODINIT_FUNC PyInit_do_stuff(void); /*proto*/
PyMODINIT_FUNC PyInit_do_stuff(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_do_stuff(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("do_stuff", __pyx_methods, __pyx_k_Example_Cython_module_that_calls, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_poc__do_stuff) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "poc.do_stuff")) {
      if (unlikely(PyDict_SetItemString(modules, "poc.do_stuff", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * This is mainly an example of absolute imports in Cython modules.
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_3poc_8do_stuff_1hello, NULL, __pyx_n_s_poc_do_stuff); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_hello, __pyx_t_2) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init poc.do_stuff", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init poc.do_stuff");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
